...
\newcommand{\aername}{ - Project Proposal}
...
then expand and solve using Runge-Kutta methods once they are covered in MAT292. At a high-level, these solvers will generate synthetic neural data through
